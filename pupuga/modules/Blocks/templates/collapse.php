...
<div class="block-module-collapse">
    ...
    <?php foreach ($params['module']['tabs'] as $param) : ?>
        ...
        <div class="block-module-collapse__row">
            ...
            <div data-slug="<?php echo $collapseSlugs[$i] ?>" class="block-module-collapse__title <?php if ($i < 0) : ?>block-module-collapse__title--open<?php endif ?>" style="<?php echo isset($params['block']->atts['color']) ? 'color:' . $params['block']->atts['color'] : '' ?>"><?php echo $param['tab_title'] ?></div>
